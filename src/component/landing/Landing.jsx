          ...
          <React.Fragment>
              <div className="container-fluid">
                <div className="signin-modal">
                    ...
                    <div className="_right _padding-50 signin">
                      ...
                      <form action="https://www.piggyvest.com/login" method="post" className="_margin-100 signin-form">
                ...
                <section className="intro-text _margin-100">
                    <div className="container mainheroholder">
                      <div className="_mobilecenter">
                        <h1 className="_half-width _margin-50 bluecolor bold">The Better Way To Save & Invest</h1>
                        <p className="_half-width _margin-20 ashcolor">PiggyVest is your guide to financial security. We help you save responsibly and also enable you to invest on the go.<br /><br />Earn 10% - 13% interests on savings.<br />Earn over 25% return on investments.</p> 
                        
                        <a href="onboarding/register.html" class="btn waves-effect waves-light btn-outline-primary ">Create a Free Account</a>
                        <div>
                          <a href="https://www.piggybank.ng/appstorelink/ios" >
                            <img src="/images/iosbadge-101-image.png" className="download app_store_badges" alt=""/>
                          </a>
                          <a href="https://www.piggybank.ng/appstorelink/android" >
              ...
              <section className="content grayback"> 
                <div className="container _center securealertbox">
                  ...
                  <div className="textpart">
                    ...
                    <div className="textinfo ashcolor">PiggyVest uses the highest levels of Internet Security, and it is secured by 256 bits SSL security encryption to ensure that your information is completely protected from fraud.</div>
                  </div>
                </div>
              </section>
              ...
              <section className="content">
                <div className="container _center">
                  ...
                  <div className="_subtitle">PiggyVest helps you reach your savings target much faster with various savings types. Plus you can even team up with others to reach joint goals.</div>
              ...
              <section className="content investcontent">
                <div className="container _center">
                  ...
                  <div className="_subtitle">Many investments are expensive, which makes it hard to get started. At PiggyVest, you too can invest in tiny & affordable chunks and still enjoy the same return rates in amazing opportunities.</div>
                  <div className="how-works howtostart _margin-50">
                ...
                <section className="content saverofmonth-section">
                  <div className="container minicontainer">
                    <h1 className="_center _margin-20 bold">Meet Sam - The saver of the month</h1>
                    <div className="feature _margin-20">
                      <div className="_half-width _padding-20 feature-image">
                        <img style={{width: '60%'}} src="../storage.googleapis.com/piggybankservice.appspot.com/main-assets/smallpic441669a034.jpg"
                        className="meet-img" alt=""/>
                      </div>
                      <div className="_half-width _padding-20 _margin-50 feature-text featuremonth-text">
                        ...
                        <a href="https://medium.com/@PiggybankNG/meetapiggyvestsaver-sam-14c037ff41e9" className="btn _margin-20">Meet Sam</a>
                      </div>
                    </div>
                  </div>
                </section>
              ...
              <section className="content cta">
                  <div className="container _center">
                    ...
                    <a href="onboarding/register.html" class="btn waves-effect waves-light btn-outline-primary">Create Account for Free</a>
